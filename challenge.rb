...
class Challenge
  ...
  def initialize(filename)
    ...
    # Store the game reults in the class variable @@game_results which will be used later to transform into to look like JSON (not exact JSON)
    @@game_results = File.read(filename).split("\n")
  ...
  class << self
    def get_teams
      # Seperate each team with their scores into a new array that has been flattened.
